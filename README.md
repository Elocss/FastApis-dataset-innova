...
```bash
git clone https://github.com/Elocss/FastApis-dataset-innova.git
cd FastApis-dataset-innova
```
...
Si no existe un archivo `requirements.txt`, instala FastAPI y Uvicorn manualmente:
...
```bash
python -c "import fastapi; import uvicorn; print('✓ Instalación correcta')"
```
